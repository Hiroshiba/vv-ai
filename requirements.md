...
| `issue`        | 自然言語指示を短く整理して議論の出発点になる Issue を作成    | ✅        | ✅     |
...
- 2 行目: `BODY:`
- 3 行目以降: Markdown 本文
- 本文はユーザーが明示した内容を中心に短く整理する
- 細かい仕様、受入基準、対象外、実装方式、テスト方針は、明示されている場合や Issue として自然に必要な場合だけ書く
- 未確定の詳細は確定仕様として断定せず、必要に応じて補足や確認したいこととして扱う
