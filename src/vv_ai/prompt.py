...
_COMMAND_TASK_DESCRIPTION: dict[str, str] = {
    ...
    "breakdown": (
        # TODO: これだと「TASK:」と途中で含めてしまったりしたらバグるので、複数ファイル書き出してそのファイルパスを書いてもらう形のほうが良い
        "task-breakdown スキルに従ってタスク分割を行ってください。\n"
        "出力は以下のフォーマットに厳密に従ってください:\n"
        "各タスクを TASK: 行で始め、次の行に TITLE: <タイトル>、その次の行に BODY:、"
        "それ以降に Markdown 本文を記述します。\n"
        "\n"
        "TASK:\n"
        "TITLE: タイトル\n"
        "BODY:\n"
        ...
        "次の本文...\n"
        "\n"
        "TASK:/TITLE:/BODY: 以外の余計な出力は含めないでください。"
